...
from src.MSCLAP.CLAPWrapper import CLAPWrapper
...
class Embedding:
    ...
    def __init__(
        ...
        self.msclap_model = CLAPWrapper(model_path, duration=audio_max_len, use_cuda=True)
    ...
    def get_embedding_as_numpy(self, audiofiles, embedding_type='scene') -> np.ndarray:
        ...
        for audiofile in audiofiles:
            audio_embeddings = self.msclap_model.get_audio_embeddings([audiofile], 
                                                                      resample=False)
